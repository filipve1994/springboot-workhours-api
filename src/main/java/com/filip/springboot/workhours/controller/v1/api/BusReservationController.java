...
import com.filip.springboot.workhours.controller.v1.request.BookTicketRequest;
import com.filip.springboot.workhours.controller.v1.request.GetTripSchedulesRequest;
...
public class BusReservationController {
    ...
    public Response getTripsByStops(@RequestBody @Valid GetTripSchedulesRequest getTripSchedulesRequest) {
        ...
        return Response.notFound()
                .setErrors(
                        String.format("No trips between source stop - '%s' and destination stop - '%s' are available at this time.",
                                getTripSchedulesRequest.getSourceStop(), getTripSchedulesRequest.getDestinationStop()));
    }
